    ...
    <div className={`flex flex-col ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'} bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group`}>
      ...
      <div className="md:w-2/5 relative overflow-hidden">
        ...
        <img
          src={blog.imageUrl}
          alt={blog.title}
          className="w-full h-48 md:h-full object-cover transform scale-100 transition-transform duration-700 group-hover:scale-105"
        />
      </div>
    ...
    <section className="py-12 bg-gray-50">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-center mb-8">
          <span className="inline-block px-3 py-1 mb-3 text-xs font-medium bg-gradient-to-r from-[#4F46E5] to-[#7C3AED] text-white rounded-full shadow-lg shadow-indigo-500/30">
            Blog & Artikel
          </span>
          <h2 className="text-3xl font-bold text-gray-900 mb-3">Cerita Inspiratif</h2>
        ...
        <div className="text-center mt-8">
          <Link to="/articlehomepage" className="inline-flex items-center justify-center space-x-2 bg-white text-[#4F46E5] font-medium px-6 py-2 rounded-lg border border-[#4F46E5] hover:bg-[#4F46E5] hover:text-white transition-all duration-300 shadow-lg shadow-indigo-500/10 group">
