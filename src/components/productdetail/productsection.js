...
import { faHeart as faHeartSolid, faComment, faShareSquare, faShoppingCart } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="product-details w-full md:w-2/5 pl-4">
          ...
          <div className="product-reviews text-yellow-500 mb-2">
            <span>⭐⭐⭐⭐☆</span> <span className="text-gray-600">({productData.reviews} Reviews)</span> | <span className={`${productData.stock > 0 ? 'text-green-600' : 'text-red-600'}`}>
