    ...
    <div className="min-h-screen bg-gradient-to-br from-[#4F46E5]/10 to-[#7C3AED]/10">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Wishlist Saya</h1>
          <p className="text-xl text-gray-600 leading-relaxed">Simpan produk favorit Anda dan dapatkan notifikasi ketika ada promo menarik</p>
        </div>
